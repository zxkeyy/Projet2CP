...
const createCheckSession = async (req, res) => {
  const { products, total_price, phoneNumber, address, wilaya } = req.body;
...
const stripeWebHook = async (req, res) => {
  ...
  const endpointSecret =
    "whsec_00a1518728a9142c9ac9acd5463b1d9b56e1989035475664507e7e78dc13c3a8";
  try {
  ...
  if (event.type === "checkout.session.completed") {
    ...
    const { userId, products, total_price, phoneNumber, address, wilaya } =
      session.metadata;

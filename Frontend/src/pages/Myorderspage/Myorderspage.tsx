import { Box, Button, Flex, HStack, Heading, Skeleton, SkeletonText, Text } from "@chakra-ui/react";
    ...
    return(
        ...
        <Flex my="30px" flexDir="column" bg="#F8F8F8" px="30px" boxShadow="0px 1px 13px 0px #0000000D">
            <Flex justifyContent="space-between" color="#232321CC" alignItems="center" h="50px" borderBottom="1px solid #E2E8F0">
                ...
                <Text w="70px" fontSize="lg" fontWeight="500">Status</Text>
                <Box w="100px"></Box>
            </Flex>
            {isLoading ? (
          // Display loading skeletons while data is being fetched
          <>
            <Flex alignItems="center" justifyContent="space-between" h="55px" px="5px" borderBottom="1px solid #E2E8F0" key="loading">
            ...
            <Flex alignItems="center" justifyContent="space-between" h="55px" px="5px" borderBottom="1px solid #E2E8F0" key="loading2">
              <SkeletonText w="100px"  />
              <SkeletonText w="56px" mr="85px" />
              <HStack>
                <Skeleton h="12px" w="12px" borderRadius="50%" />
            ...
            orders.map((order) =>(
                <Flex 
                    ...
                    <Text w="56px" mr="25px">${order.total_price}</Text>
                    <HStack>
                        <Box 
                            h="12px" 
                            w="12px" 

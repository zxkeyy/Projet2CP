import { Heading, Card, CardBody, CardFooter, Box, Text, Image } from "@chakra-ui/react"
      ...
      >
        <Box>
          <Box
            ...
            marginBottom={"1%"}
          ></Box>
          <Heading fontSize="30px" marginBottom={"3%"}>
            Our services
          </Heading>
          <Box
            display={"flex"}
              ...
              <CardBody>
                ...
                >
                  ...
                  <Text
                    ...
                    marginTop={"5%"}
                  >
                    We have expertise in CCTV systems installations. We are
                    using products
                  </Text>
                </Box>
              </CardBody>
